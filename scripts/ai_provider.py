...
class _OpenAIProvider:
    def __init__(self, cfg: Dict[str, Any]):
        try:
            ...
            raise AIError(f"openai package not installed: {e}")
...
class _AnthropicProvider:
    def __init__(self, cfg: Dict[str, Any]):
        try:
            ...
            raise AIError(f"anthropic package not installed: {e}")
...
class _GeminiProvider:
    def __init__(self, cfg: Dict[str, Any]):
        try:
            ...
            raise AIError(f"google-generativeai package not installed: {e}")
...
class _OllamaProvider:
    def __init__(self, cfg: Dict[str, Any]):
        try:
            ...
            raise AIError(f"ollama package not installed: {e}")
